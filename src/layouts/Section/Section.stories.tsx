  ...
  <>
    <Section bg="violets.2">
      <Container bg="white">
        ...
        in metus. Proin sed libero enim sed faucibus turpis in eu. Dui id ornare
        arcu odio ut sem nulla pharetra. Elit at imperdiet dui accumsan sit
        amet. Sagittis aliquam malesuada bibendum arcu vitae elementum curabitur
        vitae.
      </Container>
    </Section>
    <Section bg="violets.2">
      <Container bg="white">
        ...
        praesent semper feugiat nibh sed pulvinar. Cursus mattis molestie a
        iaculis at erat pellentesque. Sit amet venenatis urna cursus eget nunc
        scelerisque viverra mauris. Adipiscing at in tellus integer feugiat
        scelerisque. Porta lorem mollis aliquam ut porttitor leo. Nibh cras
        pulvinar mattis nunc sed blandit libero. Tincidunt praesent semper
        feugiat nibh sed pulvinar proin gravida hendrerit. Fringilla ut morbi
    ...
    <Section bg="violets.2">
      <Container bg="white">
        ...
        velit. Tristique magna sit amet purus. Aenean sed adipiscing diam donec
        adipiscing tristique risus. Ac tortor vitae purus faucibus ornare.
        Senectus et netus et malesuada fames ac turpis. Lacus luctus accumsan
